...
- **1** Definitions
- **2** Boundary
- **2.1** Application ofConstitutional Amendment Approval Act
- **3** Boundary commissioners
- **4** Settlement of disputes
- **5** Establishment of surveyed boundary
- **6** Mapping the provisional boundary line
- **7** Recording boundary alterations
- **8** Canada not bound to pay costs
- **9** Power to make regulations
- **10** Legislative consent
...
## Application ofConstitutional Amendment Approval Act
