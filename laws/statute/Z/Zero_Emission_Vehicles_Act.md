...
- **39.1** Information held by Insurance Corporation of British Columbia
...
**4** For the purposes of this Act, ZEV units are classified as follows:
  ...
  - (a) if the ZEV unit is a credit issued in relation to the supply of a zero-emission vehicle, the ZEV unit has the model year, vehicle class and ZEV class of the zero-emission vehicle;
...
(i) the number of consumer sales in British Columbia of specified motor vehicles;

(ii) the number of consumer sales in British Columbia of specified motor vehicles that are zero-emission vehicles, and
...
**10(1)** This section applies on assessment under section 19 [assessment by director] or reassessment under section 20 [reassessment by director].
  ...
  (3) Subject to subsection (4), if a supplier has a balance at the end of the compliance date for a model year that contains less than zero ZEV units of a vehicle class and ZEV class,
  ...
  (4) Subsection (3) does not apply to a supplier in relation to a model year, vehicle class and ZEV class unless the supplier had a balance at the end of the compliance date for the previous model year that contained less than zero ZEV units of the same vehicle class and any ZEV class.

  (5) An increase under subsection (3) (b) takes effect on the day after the compliance date to which the administrative penalty relates.
...
## Issuance of credits — supply


**13(1)** Subject to subsection (3) and the regulations, the director may, in any of the following circumstances, issue credits to a supplier of a vehicle make in relation to the supply of new zero-emission vehicles of the vehicle make:
  ...
  (2) An application under subsection (1) (a) must be made in accordance with the regulations and relate to the supply of zero-emission vehicles during a prescribed period of time.
...
**14(1)** If the director enters into an agreement under this section with a supplier, the director must issue credits to the supplier in accordance with the agreement.
  ...
  - (b) increasing use, sales or leases of zero-emission vehicles in British Columbia.
...
**17(1)** In this section, "adjustment period", in relation to a model year report, means the period that
  ...
  (4) The model year report must include the following information about new motor vehicles supplied on or before the compliance date for the reported model year, for each vehicle make referred to in subsection (3) (b) and each vehicle class and, if applicable, ZEV class:

  - (a) the number of new motor vehicles supplied;

  - (a.1) the number of new motor vehicles supplied that are zero-emission vehicles;

  - (b) the vehicle model and vehicle identification number of each zero-emission vehicle supplied;
...
(ii) section 13 (1) (a) [issuance of credits on application — supply];
...
(v) section 16 [transfer of credits];
  ...
  - (e) the number of credits, by vehicle class and ZEV class, claimed by the supplier in relation to the supply of zero-emission vehicles of the vehicle makes referred to in subsection (3) (b) and the reported model year for which credits have not been issued under section 13 (1) (a);
...
**18(1)** A supplier must submit a supplementary report to the director within 30 days after the supplier becomes aware that
  ...
  - (a) information in a previous model year report or supplementary report did not completely and accurately disclose the information required to be included in the report, or
...
**19(1)** On receipt of a model year report from a supplier, the director must serve on the supplier a notice of assessment that sets out the following for each vehicle class:
  ...
  - (d) if applicable, the number of credits, by model year, vehicle class and ZEV class, that the director issues in relation to the supply of new zero-emission vehicles of the vehicle makes referred to in section 17 (3) (b) and the reported model year for which credits have not been issued under section 13 (1) (a) [issuance of credits on application — supply];
...
(ii) specifying the amount of the administrative penalty determined under section 26 [automatic administrative penalties] and requiring the supplier to pay the specified amount.
...
**22(1)** On request by the director, a supplier of a vehicle make must provide information about the supply of new motor vehicles of the vehicle make, by model year, vehicle class or ZEV class, within the period of time specified by the director.

  (2) On request by the director, a supplier who submits a model year report or supplementary report must provide additional information in relation to the reported model year within the period of time specified by the director.
...
**23(1)** The director may
  ...
  - (a) require a supplier who submits a model year report or supplementary report to have the report audited in accordance with the directions of the director, or

  - (b) conduct or authorize a person to conduct an audit of a model year report or supplementary report.
...
**30(1)** A person who contravenes any of the following provisions commits an offence:
  ...
  - (c.1) section 18.1 [forecast report];
  ...
  (3) A person convicted of an offence under subsection (1) (b), (c), (c.1), (d) or (e) or (2) is liable to a fine of not more than $1 000 000 or imprisonment for a term of not more than 6 months, or both.
...
**31(1)** A person commits an offence and is liable on conviction to a fine of not more than $1 000 000 or imprisonment for a term of not more than 6 months, or both, if the person knowingly provides false or misleading information
  ...
  (3) [Repealed 2023-41-24.]

  (4) A person does not commit an offence under subsection (2) if, at the time the information was provided, the person, with the exercise of reasonable diligence, could not have known that the information was false or misleading.
...
(ii) other characteristics of the supplier or affiliates or agents of the supplier;
  ...
  - (d) respecting when a person is deemed to be the supplier of a vehicle make for the purposes of the definition of "supplier" in section 1.
...
(i) respecting applications under section 13 (1) (a) [issuance of credits on application — supply],

(ii) specifying the number of credits to be issued in relation to the supply of each new zero-emission vehicle, or providing a method for determining that number,
